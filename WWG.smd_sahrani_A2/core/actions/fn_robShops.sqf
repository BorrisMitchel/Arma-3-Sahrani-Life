...
_chance = random(100);
if(_chance >= 0) then { hint "The cashier hit the silent alarm, police has been alerted!"; [[1,format["ALARM! - Gasstation: %1 is being robbed!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
...
_cP = 0.01;
 [[0,format["ALARM! - Gasstation is being robbed!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
if(_rip) then
{
while{true} do
{
...
_pgText ctrlSetText format["Robbery in Progress, stay close (10m) (%1%2)...",round(_cP * 500)," of 500"];
