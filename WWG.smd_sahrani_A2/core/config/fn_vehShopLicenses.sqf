...
switch (life_veh_shop select 0) do
{
	...
	case "high_end_car": {_ret = license_civ_driver;};
	...
	case "lamborghini": {_ret = license_civ_driver;};
	case "ford": {_ret = license_civ_driver;};
	case "dodge": {_ret = license_civ_driver;};
	case "porsche": {_ret = license_civ_driver;};
	case "adminmenu": {_ret = license_civ_driver;};
