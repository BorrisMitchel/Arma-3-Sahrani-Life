...
switch (_filter) do
{
	...
	{
		[
			["A3L_sombrero","Sombrero",200],
			["A3L_russianhat","Russian Hat",200],
			["A3L_crown","Crown",200],
			["A3L_longhairblond","Long Hair Blonde",200],
			["A3L_longhairblack","Long Hair Black",200],
			["A3L_longhairbrown","Long Hair Brown",200],
			["A3L_mexicanhat","Mexican Hat",200],
