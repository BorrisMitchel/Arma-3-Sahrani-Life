...
switch (_shop) do
{
	case "market": {["Market",["water","rabbit","apple","redgull","tbacon","pickaxe","fuelF","peach","boltcutter","storagesmall","storagebig"]]};
	...
	case "black": {["Black Market",["lockpick","boltcutter","blastingcharge"]]};
